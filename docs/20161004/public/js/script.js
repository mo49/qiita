...
var _ParticleSetting = require('./ParticleSetting');
...
var Vertex3d = function () {
  ...
  _createClass(Vertex3d, [{
    key: 'vertexUpdate',
    value: function vertexUpdate() {
      this.affineOut = _ParticleSetting.affine.process(this.affineIn.vertex, this.affineIn.size, this.affineIn.rotate, this.affineIn.position, _ParticleSetting.camera.display);
    }
  }]);
...
var Particle = function () {
  ...
  _createClass(Particle, [{
    ...
    value: function init() {
      ...
      this.canvas.width = _ParticleSetting.uv.ww;
      this.canvas.height = _ParticleSetting.uv.wh;
      ...
      for (var i = 0, len = this.particleNum; i < len; i++) {
        this.vertex[i] = new Vertex3d({
          vertex: { x: _ParticleSetting.uf.randomPos(), y: _ParticleSetting.uf.randomPos(), z: _ParticleSetting.uf.randomPos() },
          size: { x: 0, y: 0, z: 0 },
      ...
      this.cubeSize = {
        x: _ParticleSetting.uv.ww / 100 * this.cubeboxSize,
        y: _ParticleSetting.uv.wh / 100 * this.cubeboxSize,
        z: _ParticleSetting.uv.ww / 100 * this.cubeboxSize
      };
    }
  }, {
    key: 'draw',
    value: function draw() {
      ...
      _ParticleSetting.camera.update();
      ...
      for (var i = 0; i < this.vertex.length; i++) {
        ...
        var particleColor = _ParticleData.PARTICLE_DATA[i] ? _ParticleData.PARTICLE_DATA[i].color : this.particleColor;
        var particleSize = _ParticleData.PARTICLE_DATA[i] ? _ParticleData.PARTICLE_DATA[i].size : this.particleSize;
      ...
      for (var s = 0; s < this.dist.length; s++) {
        for (var k = 0; k < this.dist.length; k++) {
          ...
          var currentDistance = _ParticleSetting.uf.calcDistance(this.dist[s], this.dist[k]);

          if (currentDistance < this.limitDistance) {
            this.ctx.save();
            this.ctx.beginPath();
            var alpha = (this.limitDistance - currentDistance) / this.limitDistance;
...
},{"./ParticleData":3,"./ParticleSetting":4}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var PARTICLE_DATA = exports.PARTICLE_DATA = [{
	size: 5,
...
var uv = exports.uv = { // util variable
  ww: window.innerWidth,
  wh: window.innerHeight
};
var uf = exports.uf = { // util function
  dtr: function dtr(d) {
  ...
  calcDistance: function calcDistance(p1, p2, p3) {
...
var camera = exports.camera = {
  ...
  update: function update() {
    var cd = camera.distance;
    var ct = camera.target;
